...
<html>
	...
	<body>
		...
		<form method="POST" action="../contoller/check.php"enctype="multipart/form-data">
			<center>
				...
				<table  align="center" width="100%" >
						...
						<tr height="60px">
							...
							<td colspan="" style="color:green; font-size:15;margin: 10%; text-align:left; "><a href="../contoller/logout.php">Logout</a> </td>

						</tr><tr height="10px"><td colspan="3"></td></tr>
				
					<tr>
						<td colspan="3" style="color:green;font-size:20;"><b>Current Account:<input type="account" name="account"value="<?php$_REQUEST['account']?>"></b></td>
                ...
                <option value="B+">PQR bank</option>
						...
						<tr>
							<td colspan="3" align="center" height="40px" style="background:mediumseagreen;">
								<a href="../views/dashboard.php" style="color: white;font-size:25;width:40%;height:80%;">Dashboard</a>
							</td>
						</tr>
